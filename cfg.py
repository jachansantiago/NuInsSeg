...
def parse_args():    
    ...
    parser.add_argument('-arch', type=str, default='vit_t', help='net architecture, pick between vit_h, vit_b, vit_t')
    ...
    parser.add_argument('-train_img_list', type=str, default='./datasets/MRI-Prostate/train_5shot.csv')
    parser.add_argument('-val_img_list', type=str,default='./datasets/MRI-Prostate/val_5shot.csv')
    ...
    parser.add_argument('-sam_ckpt', type=str, default='efficient_sam_vitt.pt', help='the path to the checkpoint to load')
